...
from revisited.r_dispatch.dispatch import Dispatcher, DoesNotExistError, EventExistsError, PropertyExistsError
from revisited.r_dispatch.properties import Property
